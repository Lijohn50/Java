    ...
    public void saveEvent()
    {
        ...
        else
        {
            ...
            try
            {
                ...
                String query = "INSERT INTO dressdata VALUES('" + name + "','" + type + "','" + color + "'," + price + ",'" + date + "'," + quantity + ",'" + boost + "'," + discount + ",'" + details + "','" + gender + "','" + size + "','" + imagePath + "');";
                Product product = new Product(name, type, color, price, date, quantity, boost, imagePath);
